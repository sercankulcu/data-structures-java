...
public class CiftYonluBagliListe {
	...
	CiftYonluBagliListe donustur(TekYonluBagliListe liste1) {
		// Cift yonlu bagli listeyi olustur
		CiftYonluBagliListe liste2 = new CiftYonluBagliListe();

		// Ilk dugumu isaret et
		TekYonluDugum<Integer> gecici = liste1.bas;

		// Tek yonlu listedeki her dugumu cift yonlu listeye ekleyin
		while (gecici != null) {
			liste2.sonaEkle(gecici.veri); // Cift yonlu listeye dugumu ekle
			gecici = gecici.sonraki; // Tek yonlu listede bir sonraki dugume gec
		}

		return liste2; // Donusturulmus cift yonlu listeyi dondur
	}
